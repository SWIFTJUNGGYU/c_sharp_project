...
{
    public partial class COM01020101_F : DevExpress.XtraEditors.XtraForm
    {
        ...
        // [그리드 데이터 리스트 조회 Method]
        public void showGridDataList ()
        {
            IList<COM01020101Info> list = LogicManager.com01020101_l.getBookmarkList();
            Grd_Bookmark.DataSource = list;
